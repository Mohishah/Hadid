          ...
          <div className="container mil-p-120-120">
              ...
              <div className="row">
                  <div className="col-lg-10">
                      <span className="mil-suptitle mil-suptitle-right mil-suptitle-dark mil-up" dangerouslySetInnerHTML={{__html : testi.subtitle}} />
                  </div>
              </div>

              <h2 className="mil-center mil-up mil-mb-60" dangerouslySetInnerHTML={{__html : testi.title}} />
